(()=>{var a={};a.id=673,a.ids=[673],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},297:(a,b,c)=>{"use strict";c.r(b),c.d(b,{handler:()=>J,patchFetch:()=>I,routeModule:()=>E,serverHooks:()=>H,workAsyncStorage:()=>F,workUnitAsyncStorage:()=>G});var d={};c.r(d),c.d(d,{DELETE:()=>D,GET:()=>A,PATCH:()=>C,POST:()=>B});var e=c(6559),f=c(8088),g=c(7719),h=c(6191),i=c(1289),j=c(261),k=c(2603),l=c(9893),m=c(4823),n=c(7220),o=c(6946),p=c(7912),q=c(9786),r=c(6143),s=c(6439),t=c(3365),u=c(2190),v=c(7916),w=c(6031);let x=v.Ik({description:v.Yj().min(1).max(200),amount:v.ai().positive(),payerId:v.Yj().min(1),beneficiaryIds:v.YO(v.Yj().min(1)).default([]),date:v.Yj().date().optional()}),y=v.Ik({expenseId:v.Yj().min(1),beneficiaryId:v.Yj().min(1)}),z=v.Ik({expenseId:v.Yj().min(1),beneficiaryIds:v.YO(v.Yj().min(1))});async function A(){let a=await (0,w.bV)();return u.NextResponse.json(a)}async function B(a){let b=await a.json().catch(()=>({})),c=x.safeParse(b);if(!c.success)return u.NextResponse.json({error:"Invalid payload"},{status:400});let d=await (0,w.ZN)(c.data);return u.NextResponse.json(d,{status:201})}async function C(a){let b=await a.json().catch(()=>({})),c=y.safeParse(b);if(c.success){let a=await (0,w.YZ)(c.data.expenseId,c.data.beneficiaryId);return a?u.NextResponse.json(a):u.NextResponse.json({error:"Not found"},{status:404})}let d=z.safeParse(b);if(d.success){let a=await (0,w.Yc)(d.data.expenseId,d.data.beneficiaryIds);return a?u.NextResponse.json(a):u.NextResponse.json({error:"Not found"},{status:404})}return u.NextResponse.json({error:"Invalid payload"},{status:400})}async function D(a){let{searchParams:b}=new URL(a.url),c=b.get("id");return c?await (0,w.Wz)(c)?new u.NextResponse(null,{status:204}):u.NextResponse.json({error:"Not found"},{status:404}):u.NextResponse.json({error:"Missing id"},{status:400})}let E=new e.AppRouteRouteModule({definition:{kind:f.RouteKind.APP_ROUTE,page:"/api/expenses/route",pathname:"/api/expenses",filename:"route",bundlePath:"app/api/expenses/route"},distDir:".next-prod",projectDir:"",resolvedPagePath:"D:\\Workspace\\man-weekend-dashboard\\src\\app\\api\\expenses\\route.ts",nextConfigOutput:"",userland:d}),{workAsyncStorage:F,workUnitAsyncStorage:G,serverHooks:H}=E;function I(){return(0,g.patchFetch)({workAsyncStorage:F,workUnitAsyncStorage:G})}async function J(a,b,c){var d;let e="/api/expenses/route";"/index"===e&&(e="/");let g=await E.prepare(a,b,{srcPage:e,multiZoneDraftMode:"false"});if(!g)return b.statusCode=400,b.end("Bad Request"),null==c.waitUntil||c.waitUntil.call(c,Promise.resolve()),null;let{buildId:u,params:v,nextConfig:w,isDraftMode:x,prerenderManifest:y,routerServerContext:z,isOnDemandRevalidate:A,revalidateOnlyGenerated:B,resolvedPathname:C}=g,D=(0,j.normalizeAppPath)(e),F=!!(y.dynamicRoutes[D]||y.routes[C]);if(F&&!x){let a=!!y.routes[C],b=y.dynamicRoutes[D];if(b&&!1===b.fallback&&!a)throw new s.NoFallbackError}let G=null;!F||E.isDev||x||(G="/index"===(G=C)?"/":G);let H=!0===E.isDev||!F,I=F&&!H,J=a.method||"GET",K=(0,i.getTracer)(),L=K.getActiveScopeSpan(),M={params:v,prerenderManifest:y,renderOpts:{experimental:{dynamicIO:!!w.experimental.dynamicIO,authInterrupts:!!w.experimental.authInterrupts},supportsDynamicResponse:H,incrementalCache:(0,h.getRequestMeta)(a,"incrementalCache"),cacheLifeProfiles:null==(d=w.experimental)?void 0:d.cacheLife,isRevalidate:I,waitUntil:c.waitUntil,onClose:a=>{b.on("close",a)},onAfterTaskError:void 0,onInstrumentationRequestError:(b,c,d)=>E.onRequestError(a,b,d,z)},sharedContext:{buildId:u}},N=new k.NodeNextRequest(a),O=new k.NodeNextResponse(b),P=l.NextRequestAdapter.fromNodeNextRequest(N,(0,l.signalFromNodeResponse)(b));try{let d=async c=>E.handle(P,M).finally(()=>{if(!c)return;c.setAttributes({"http.status_code":b.statusCode,"next.rsc":!1});let d=K.getRootSpanAttributes();if(!d)return;if(d.get("next.span_type")!==m.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${d.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let e=d.get("next.route");if(e){let a=`${J} ${e}`;c.setAttributes({"next.route":e,"http.route":e,"next.span_name":a}),c.updateName(a)}else c.updateName(`${J} ${a.url}`)}),g=async g=>{var i,j;let k=async({previousCacheEntry:f})=>{try{if(!(0,h.getRequestMeta)(a,"minimalMode")&&A&&B&&!f)return b.statusCode=404,b.setHeader("x-nextjs-cache","REVALIDATED"),b.end("This page could not be found"),null;let e=await d(g);a.fetchMetrics=M.renderOpts.fetchMetrics;let i=M.renderOpts.pendingWaitUntil;i&&c.waitUntil&&(c.waitUntil(i),i=void 0);let j=M.renderOpts.collectedTags;if(!F)return await (0,o.I)(N,O,e,M.renderOpts.pendingWaitUntil),null;{let a=await e.blob(),b=(0,p.toNodeOutgoingHttpHeaders)(e.headers);j&&(b[r.NEXT_CACHE_TAGS_HEADER]=j),!b["content-type"]&&a.type&&(b["content-type"]=a.type);let c=void 0!==M.renderOpts.collectedRevalidate&&!(M.renderOpts.collectedRevalidate>=r.INFINITE_CACHE)&&M.renderOpts.collectedRevalidate,d=void 0===M.renderOpts.collectedExpire||M.renderOpts.collectedExpire>=r.INFINITE_CACHE?void 0:M.renderOpts.collectedExpire;return{value:{kind:t.CachedRouteKind.APP_ROUTE,status:e.status,body:Buffer.from(await a.arrayBuffer()),headers:b},cacheControl:{revalidate:c,expire:d}}}}catch(b){throw(null==f?void 0:f.isStale)&&await E.onRequestError(a,b,{routerKind:"App Router",routePath:e,routeType:"route",revalidateReason:(0,n.c)({isRevalidate:I,isOnDemandRevalidate:A})},z),b}},l=await E.handleResponse({req:a,nextConfig:w,cacheKey:G,routeKind:f.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:y,isRoutePPREnabled:!1,isOnDemandRevalidate:A,revalidateOnlyGenerated:B,responseGenerator:k,waitUntil:c.waitUntil});if(!F)return null;if((null==l||null==(i=l.value)?void 0:i.kind)!==t.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==l||null==(j=l.value)?void 0:j.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});(0,h.getRequestMeta)(a,"minimalMode")||b.setHeader("x-nextjs-cache",A?"REVALIDATED":l.isMiss?"MISS":l.isStale?"STALE":"HIT"),x&&b.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let m=(0,p.fromNodeOutgoingHttpHeaders)(l.value.headers);return(0,h.getRequestMeta)(a,"minimalMode")&&F||m.delete(r.NEXT_CACHE_TAGS_HEADER),!l.cacheControl||b.getHeader("Cache-Control")||m.get("Cache-Control")||m.set("Cache-Control",(0,q.getCacheControlHeader)(l.cacheControl)),await (0,o.I)(N,O,new Response(l.value.body,{headers:m,status:l.value.status||200})),null};L?await g(L):await K.withPropagatedContext(a.headers,()=>K.trace(m.BaseServerSpan.handleRequest,{spanName:`${J} ${a.url}`,kind:i.SpanKind.SERVER,attributes:{"http.method":J,"http.target":a.url}},g))}catch(b){if(L||b instanceof s.NoFallbackError||await E.onRequestError(a,b,{routerKind:"App Router",routePath:D,routeType:"route",revalidateReason:(0,n.c)({isRevalidate:I,isOnDemandRevalidate:A})}),F)throw b;return await (0,o.I)(N,O,new Response(null,{status:500})),null}}},846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},3033:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3295:a=>{"use strict";a.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},4870:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6031:(a,b,c)=>{"use strict";c.d(b,{$Q:()=>m,ZN:()=>p,tz:()=>y,gr:()=>u,Wz:()=>r,ug:()=>z,oP:()=>l,bV:()=>o,$D:()=>A,XM:()=>w,HW:()=>v,Yc:()=>s,YZ:()=>q});var d=c(9232),e=c(8909);let f=null;function g(){if(!f){let a=process.env.DATABASE_URL;if(!a)throw Error("DATABASE_URL is not set. Please add it to your environment (e.g. .env.local)");f=(0,e.lw)(a)}return f}let h=null;function i(){return h||(h=(async()=>{let a=g();await a`
  ...
  `)[0];return!!c?.is_payer||!!c?.is_beneficiary}async function u(a){if(await i(),await t(a))return{ok:!1,reason:"referenced"};let b=g();return 0===(await b`delete from attendees where id = ${a} returning id`).length?{ok:!1,reason:"not_found"}:{ok:!0}}async function v(){await i();let a=g();return(await a`select id, name, category from stuff_items order by name asc`).map(a=>({id:String(a.id),name:String(a.name),category:a.category??null}))}async function w(){await i();let a=g();return(await a`
    select se.id,
           se.quantity,
           se.created_at,
           si.id as item_id,
  ...
  `).map(a=>({id:String(a.id),itemId:String(a.item_id),itemName:String(a.item_name),itemCategory:a.item_category??null,attendeeId:String(a.attendee_id),attendeeName:String(a.attendee_name),quantity:Number(a.quantity),createdAt:new Date(String(a.created_at)).toISOString()}))}async function x(a,b){let c=g(),e=a.trim().toLowerCase(),f=(b||"").trim().toLowerCase()||null,h=(await c`select id, name, category from stuff_items where name = ${e} limit 1`)[0];if(h)return{id:String(h.id),name:String(h.name),category:h.category??null};let i=(0,d.Ak)(),j=(await c`insert into stuff_items (id, name, category) values (${i}, ${e}, ${f}) returning id, name, category`)[0];return{id:String(j.id),name:String(j.name),category:j.category??null}}async function y(a){await i();let b=g(),c=await x(a.thingName,a.category??null),e=(0,d.Ak)(),f=Math.max(1,Math.floor(Number(a.quantity))||1),h=(await b`
    insert into stuff_entries (id, item_id, attendee_id, quantity)
    values (${e}, ${c.id}, ${a.attendeeId}, ${f})
    returning id, quantity, created_at
  `)[0],j=await b`select name from attendees where id = ${a.attendeeId} limit 1`,k=String(j[0]?.name||"");return{id:String(h.id),itemId:c.id,itemName:c.name,itemCategory:c.category??null,attendeeId:a.attendeeId,attendeeName:k,quantity:Number(h.quantity),createdAt:new Date(String(h.created_at)).toISOString()}}async function z(a){await i();let b=g();return(await b`delete from stuff_entries where id = ${a} returning id`).length>0}async function A(){await i();let a=g();return(await a`select distinct category from stuff_items where category is not null order by category asc`).map(a=>String(a.category))}},6439:a=>{"use strict";a.exports=require("next/dist/shared/lib/no-fallback-error.external")},6487:()=>{},7598:a=>{"use strict";a.exports=require("node:crypto")},8335:()=>{},9294:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-async-storage.external.js")}};var b=require("../../../webpack-runtime.js");b.C(a);var c=b.X(0,[985,55,612,916],()=>b(b.s=297));module.exports=c})();